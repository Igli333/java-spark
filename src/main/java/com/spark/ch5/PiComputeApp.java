...
public class PiComputeApp implements Serializable {
    ...
    private void start(int slices) {
        ...
        int dartsInCircle = dartsDs.reduce((ReduceFunction<Integer>) new DartReducer());
    ...
    class DartMapper implements MapFunction<Row, Integer> {
    ...
    class DartReducer implements scala.Function2<Integer, Integer, Integer>, ReduceFunction<Integer> {
        @Override
